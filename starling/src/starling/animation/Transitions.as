...
package starling.animation
{
	...
	public class Transitions
	{
		...
		public static const EASYEASE:String="easyease";
		...
		private static function registerDefaultTransitions():void
		{
			...
			registerTransition(EASYEASE, easyease);
		...
		private static function easyease(current:Number, target:Number, ratio:Number):Number
		{
