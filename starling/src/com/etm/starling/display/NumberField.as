package com.etm.starling.display
{
	...
	public class NumberField extends Sprite
	{
		 ...
		 * @return
		 */
		public function get characterSpacing():Number
		{
			return _characterSpacing;
		}

		public function set characterSpacing(value:Number):void
		{
		 ...
		 */
		public function NumberField(label:String,
			textureAtlas:TextureAtlas,
			texturePrefix:String="font",
			textureSkin:String="default",
			placeValues:uint=5,
			floatPlaceValues:uint=1,
			align:String="left",
			showNegative:Boolean=true,
			showFrontZeros:Boolean=true,
